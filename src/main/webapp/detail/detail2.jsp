...
<body>
    ...
    <nav>
        <div id="plus_wrap">
            <a id="plus_content" href="./detail2.jsp">세부 정보</a><span id="plus_content">></span><a id="plus_content" href="../place.jsp">관광지 소개</a><span id="plus_content">></span><a id="plus_content" href="../index.jsp">Main</a>
        </div>
    </nav>

    <article>
        <div id="map_wrap">
            <img id="img" src="../img/place_img/cheong.jpg" alt="">
            <iframe id="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12578.519136078194!2d127.79108093955075!3d37.985768300000004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3562f281d985ba23%3A0xdce55f1558cdb109!2z64yA7ZWc67aI6rWQ7KGw6rOE7KKFIOyyre2PieyCrA!5e0!3m2!1sko!2skr!4v1655121433704!5m2!1sko!2skr"
			allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <div id="intro">
            <ul id="ul_img">
                <li id="name">청평사 조계종</li>
                <li id="address">강원도 춘천시 북산면 오봉산길 810</li>
                <li id="num">033-244-1095</li>
            </ul>
        </ul>
    </article>
