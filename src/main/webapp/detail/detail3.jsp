...
<body>
    ...
    <nav>
        <div id="plus_wrap">
            <a id="plus_content" href="./detail3.jsp">세부 정보</a><span id="plus_content">></span><a id="plus_content" href="../place.jsp">관광지 소개</a><span id="plus_content">></span><a id="plus_content" href="../index.jsp">Main</a>
        </div>
    </nav>

    <article>
        <div id="map_wrap">
            <img id="img" src="../img/place_img/garden.jpg" alt="">
            <iframe id="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3151.1859504781246!2d127.53781352789163!3d37.8325324149759!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3562d8a7866b02f9%3A0xd20f339c42e4ea33!2z7KCc7J2065Oc6rCA65OgIOyImOuqqeybkA!5e0!3m2!1sko!2skr!4v1655121547297!5m2!1sko!2skr"
			allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
        <div id="intro">
            <ul id="ul_img">
                <li id="name">제이드가든</li>
                <li id="address">강원도 춘천시 남산면 햇골길 80</li>
                <li id="num">033-260-8300</li>
            </ul>
        </ul>
    </article>
