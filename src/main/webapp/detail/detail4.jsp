...
<body>
    ...
    <nav>
        <div id="plus_wrap">
            <a id="plus_content" href="./detail4.jsp">세부 정보</a><span id="plus_content">></span><a id="plus_content" href="../place.jsp">관광지 소개</a><span id="plus_content">></span><a id="plus_content" href="../index.jsp">Main</a>
        </div>
    </nav>

    <article>
        <div id="map_wrap">
            <img id="img" src="../img/place_img/kukok.jpg" alt="">
            <iframe id="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12611.62763826932!2d127.6004119351002!3d37.792221326098485!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3563206fb5bb7a8b%3A0x1dfd95b1477d3137!2z6rWs6rOh7Y-t7Y-s!5e0!3m2!1sko!2skr!4v1655121651248!5m2!1sko!2skr"
			allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <div id="intro">
            <ul id="ul_img">
                <li id="name">구곡 폭포</li>
                <li id="address">강원도 춘천시 남산면 강촌리</li>
                <li id="num">033-261-0088</li>
            </ul>
        </ul>
    </article>
