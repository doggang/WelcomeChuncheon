...
<body>
    ...
    <nav>
        <div id="plus_wrap">
            <a id="plus_content" href="./detail6.jsp">세부 정보</a><span id="plus_content">></span><a id="plus_content" href="../place.jsp">관광지 소개</a><span id="plus_content">></span><a id="plus_content" href="../index.jsp">Main</a>
        </div>
    </nav>

    <article>
        <div id="map_wrap">
            <img id="img" src="../img/place_img/nami.jpg" alt="">
        	<iframe id="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d25221.339385239986!2d127.50803870087684!3d37.79783315431846!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x356326e41560af75%3A0xd64aaaa329e7c522!2z64Ko7J207ISs!5e0!3m2!1sko!2skr!4v1655121847322!5m2!1sko!2skr"
        	allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>    
		</div>
        <div id="intro">
            <ul id="ul_img">
                <li id="name">남이섬</li>
                <li id="address">강원도 춘천시 남산면 남이섬길 1</li>
                <li id="num">031-580-8114</li>
            </ul>
        </ul>
    </article>
