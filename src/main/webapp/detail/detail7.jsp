...
<body>
    ...
    <nav>
        <div id="plus_wrap">
            <a id="plus_content" href="./detail7.jsp">세부 정보</a><span id="plus_content">></span><a id="plus_content" href="../place.jsp">관광지 소개</a><span id="plus_content">></span><a id="plus_content" href="../index.jsp">Main</a>
        </div>
    </nav>

    <article>
        <div id="map_wrap">
            <img id="img" src="../img/place_img/rail.jpg" alt="">
            <iframe id="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100885.38762391049!2d127.4555082341292!3d37.79781112674659!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3562e5d2c8b6b1f1%3A0xad30b4a888b31cea!2z6rCV7LSM66CI7J287YyM7YGsIOq5gOycoOygleugiOydvOuwlOydtO2BrA!5e0!3m2!1sko!2skr!4v1655121941752!5m2!1sko!2skr" 
			allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <div id="intro">
            <ul id="ul_img">
                <li id="name">강촌 레일바이크</li>
                <li id="address">강원도 춘천시 신동면 김유정로 1383</li>
                <li id="num">033-245-1000</li>
            </ul>
        </ul>
    </article>
