...
<body>
    ...
    <nav>
        <div id="plus_wrap">
            <a id="plus_content" href="./detail8.jsp">세부 정보</a><span id="plus_content">></span><a id="plus_content" href="../place.jsp">관광지 소개</a><span id="plus_content">></span><a id="plus_content" href="../index.jsp">Main</a>
        </div>
    </nav>

    <article>
        <div id="map_wrap">
            <img id="img" src="../img/place_img/ski.jpg" alt="">
            <iframe id="map"src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3151.874909859362!2d127.58483031527716!3d37.81639887975195!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3562df7a5ab256ef%3A0x5ef8e2f96bf1412a!2z7JeY66as7Iuc7JWIIOqwley0jCDsiqTtgqTsnqU!5e0!3m2!1sko!2skr!4v1655122053303!5m2!1sko!2skr" 
			allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <div id="intro">
            <ul id="ul_img">
                <li id="name">엘리시안 강촌 스키장</li>
                <li id="address">강원도 춘천시 남산면 북한강변길 688</li>
                <li id="num">033-260-2000</li>
            </ul>
        </ul>
    </article>
